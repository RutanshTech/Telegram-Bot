...
const users = [
  ...
  // Add more data if you want to test vertical scroll
];
...
const Users = () => {
  ...
  const filteredUsers = users.filter(user =>
    ...
    user.paymentStatus.toLowerCase().includes(searchTerm.toLowerCase())
  );
  ...
  return (
    <div className="p-4 max-w-7xl mx-auto">
      ...
      <div className="max-h-[380px] custom-scrollbar overflow-y-auto overflow-x-auto rounded-xl shadow-md border dark:border-gray-700">
        <table className="min-w-[800px] w-full text-sm text-left bg-white dark:bg-gray-800 dark:text-white">
          <thead className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 sticky top-0 z-10">
            <tr>
          ...
          <tbody>
            {filteredUsers.map((user, index) => (
              ...
              >
                ...
                <td className="py-3 px-4">{user.selectedPlan}</td>
