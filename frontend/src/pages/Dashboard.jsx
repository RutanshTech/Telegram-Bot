...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    axios.get('https://telegram-bot-1-f9v5.onrender.com/api/kyc/today')
      .then(res => {
  ...
  useEffect(() => {
    axios.get('https://telegram-bot-1-f9v5.onrender.com/api/payment/total-revenue')
      .then(res => {
  ...
  useEffect(() => {
    axios.get('https://telegram-bot-1-f9v5.onrender.com/api/payment/total-transactions')
      .then(res => {
  ...
  useEffect(() => {
    axios.get('https://telegram-bot-1-f9v5.onrender.com/api/payment/active-users')
      .then(res => {
  ...
  useEffect(() => {
    axios.get('https://telegram-bot-1-f9v5.onrender.com/api/payment/recent-successful?limit=5')
      .then(res => {
