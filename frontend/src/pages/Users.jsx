  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const response = await axios.get('https://telegram-bot-1-f9v5.onrender.com/api/users/all');
  ...
  const handleDownloadSelectedInvoices = async () => {
    ...
    try {
      const response = await axios.post(
        'https://telegram-bot-1-f9v5.onrender.com/api/invoices/download-zip',
        { invoiceIds },
        { responseType: 'blob' }
      );
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (user.paymentStatus === "SUCCESS" || selectedUsers.includes(user._id)) {
                          window.open(`https://telegram-bot-1-f9v5.onrender.com/api/invoices/download/${user.invoiceId}`, '_blank');
                        }
                      }}
