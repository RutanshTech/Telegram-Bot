...
export default function Digio() {
  ...
  const handleSign = async () => {
    ...
    try {
      ...
      const { data } = await axios.post('https://telegram-bot-1-f9v5.onrender.com/api/digio/uploadPDF', {
        userid: userId
      });
        ...
        callback: async (response) => {
          ...
          if (response.error_code) {
            ...
            try {
              ...
              const signedRes = await axios.get(`https://telegram-bot-1-f9v5.onrender.com/api/digio/signed-link/${response.digio_doc_id}`);
      ...
      if (errorMessage.includes('Insufficient credits')) {
        ...
        if (userId) {
          try {
            await axios.post('https://telegram-bot-1-f9v5.onrender.com/api/digio/errors', {
              type: 'credit',
